						...
						for eachshow in linkList:
							...
							try:
								...
								for index,eachtime in enumerate(timeList): # get the price for each time
									...
									"start_time":start_time,"ticket":currentPerformPriceInfo,"region":location,"longitude":lng,"lattitude":lat,"category":mcidName}
									try:
